...
$(document).ready(function() {
	...
	CircleSlideshow.prototype._init = function() {
		...
		this.navLeftCtrl.innerHTML = '<i class="fa fa-chevron-right fa-4x arrow"></i>';
		...
		this.navRightCtrl.innerHTML = '<i class="fa fa-chevron-left fa-4x arrow"></i>';
	...
	var options = {
	    ...
	    weight: 20,         // Font weight (pixels)
	    rounded: false,    // Rounded letter endings
	    color: 'lightsalmon',  // Font color
